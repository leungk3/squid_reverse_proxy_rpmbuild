...
License: GPL
Group: Networking
Source: www.squid-cache.org/Versions/v4/3.4/squid-3.4.7.tar.bz2 
...
%prep
rm -rf $RPM_BUILD_DIR/squid-3.4.7
tar jxfp $RPM_SOURCE_DIR/squid-3.4.7.tar.bz2
%setup -T -D
